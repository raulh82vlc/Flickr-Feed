...
import com.raulh82vlc.flickrj.feed.data.datasource.network.FeedApi;
import com.raulh82vlc.flickrj.feed.data.datasource.network.NetworkDataSource;
import com.raulh82vlc.flickrj.feed.data.datasource.network.NetworkDataSourceImpl;
import com.raulh82vlc.flickrj.feed.data.datasource.network.connection.ConnectionHandler;
import com.raulh82vlc.flickrj.feed.data.datasource.network.connection.ConnectionHandlerImpl;
import com.raulh82vlc.flickrj.feed.data.datasource.network.response.ResponseHandler;
